...
const MODEL_POLICY = {
	design: 'claude-fable-5-1', // 설계·아키텍처 (고복잡도, 비싼 만큼 여기만)
	orchestrator: 'claude-fable-5-1', // 그룹 지휘/교차검증 (복잡도 최상)
	control: 'claude-fable-5-1', // 관제 에이전트(앱 전체: 캘린더/크론잡/설정 조작) — 지휘자와 동급 복잡도

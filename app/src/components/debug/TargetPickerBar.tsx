...
export default function TargetPickerBar() {
		...
		<div className={styles.bar}>
			...
			{!sessionId && (
				<>
					...
					/>
					<button onClick={() => startSession(null, null, url, device)} disabled={connecting} style={{ height: 32, padding: '0 13px', borderRadius: 8, background: 'var(--violet)', border: 'none', cursor: 'pointer', color: '#fff', fontSize: 12, fontWeight: 700, flex: 'none' }}>

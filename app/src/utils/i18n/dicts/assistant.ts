...
const dict: Record<string, string> = {
	...
	'비서에게 태스크 생성, 일정 조정, 크론잡 등을 자연어로 부탁해보세요.':
		'Ask the Assistant in natural language to create tasks, adjust schedules, set up cron jobs, and more.',
	'이미지 업로드 중…': 'Uploading image…',
	'비서에게 메시지… (이미지 붙여넣기 가능)': 'Message the Assistant… (you can paste images)',
	'보내기 (Enter)': 'Send (Enter)',
	'비서 세션 시작 중…': 'Starting Assistant session…',
	...
	'비서에게 물어보면서 채우기': 'Fill in by asking the Assistant',
	'비서 여는 중…': 'Opening Assistant…',
	'✦ 비서에게 물어보기': '✦ Ask the Assistant',
